    ...
    getParticipants: function getParticipants() {
        ...
        return Promise.all(users.map(function (p) {
            return ParticipantsHyperty.hypertyDiscovery.discoverHypertyPerUser(p, ParticipantsHyperty.domain).then(function (user) {
                ...
                return { email: p, online: false };
            });
        }));
    }
};

var ParticipantsHypertyFactory = function ParticipantsHypertyFactory(hypertyURL, bus, config) {
    ParticipantsHyperty.domain = new _urijs2.default(hypertyURL).hostname();
    ParticipantsHyperty.hypertyDiscovery = new _HypertyDiscovery2.default(hypertyURL, bus);
...
},{"service-framework/src/hyperty-discovery/HypertyDiscovery":1,"urijs":5}]},{},[7])(7)
});